    ...
    for (const file of uploadedFiles) {
      try {
        ...
        if (!ocrResponse.ok) {
          ...
          throw new Error(
            `OCR API error: ${errorData.error || ocrResponse.statusText}`
          );
        }
        ...
        const gbpAmount = await convertToGBP(
          amount,
          currency === "£" ? "GBP" : currency.replace(/[£$€]/g, "")
        );
        ...
        processed.push({
          ...
          originalCurrency:
            currency === "£" ? "GBP" : currency.replace(/[£$€]/g, "") || "GBP",
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-sm font-medium">
                    ...
                    {processedReceipts
                      .reduce(
                        (sum, r) => sum + parseFloat(r.gbpAmount || "0"),
                        0
                      )
                      .toFixed(2)}
                  </span>
